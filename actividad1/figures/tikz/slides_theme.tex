...
\newcommand{\webcamplaceholder}{%
  \begin{scope}
    \fill[Ink,opacity=0.12] (14.96,0.92) circle (0.66);
    \fill[white,opacity=0.94] (14.90,0.99) circle (0.64);
    \draw[Teal,line width=1.0pt] (14.90,0.99) circle (0.64);
    \draw[Line,line width=0.45pt] (14.90,0.99) circle (0.49);
  \end{scope}
}
