...
\node[anchor=west,font=\fontsize{16.2}{17.5}\selectfont\bfseries,text=Navy,text width=5.9cm,align=left] at (1.26,5.96) {Estructura grande;\\soporte logistico fino.};
\node[anchor=west,font=\fontsize{7.0}{8.2}\selectfont,text=Muted,text width=5.6cm,align=left] at (1.30,4.82) {El AMR no toca montaje certificado: estabiliza entregas, retorno de utiles, FOD y trazabilidad alrededor de la estaci\'on.};
...
\node[anchor=west,font=\fontsize{6.6}{7.7}\selectfont,text=Muted,text width=6.5cm,align=left] at (7.88,1.78) {La secci\'on 19.1 concentra dependencia de kits, herramientas, documentaci\'on y disciplina FOD. Ah\'i el AMR aporta continuidad y datos, no fabricaci\'on directa.};
