...
\node[anchor=west,font=\fontsize{15.0}{16.2}\selectfont\bfseries,text=Navy,text width=5.9cm,align=left] at (1.26,5.84) {Estructura grande;\\soporte logístico fino.};
\node[anchor=west,font=\fontsize{6.7}{7.8}\selectfont,text=Muted,text width=5.65cm,align=left] at (1.30,4.70) {El AMR no toca montaje certificado: estabiliza entregas, retorno de útiles, FOD y trazabilidad alrededor de la estaci\'on.};
...
\node[anchor=west,font=\fontsize{7.4}{8.6}\selectfont\bfseries,text=Navy,text width=6.4cm,align=left] at (7.88,2.35) {Lectura clave de planta};
