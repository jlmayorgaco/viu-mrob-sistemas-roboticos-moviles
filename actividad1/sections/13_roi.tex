...
La tabla siguiente evita que el VAN negativo se lea como conclusión comercial. El caso bajo monetiza casi solo horas recuperadas. El caso objetivo marca el beneficio anual que debe demostrarse con datos de planta para que el proyecto cierre financieramente. El caso alto añade continuidad de flujo y menos interrupciones relevantes, sin atribuir al robot la fabricación de más HTP por sí solo. El VAN se calcula con los supuestos anteriores y no incluye IVA.
