...
La plataforma objetivo se define por requisitos de operación, no por una marca cerrada. El integrador podría seleccionar un chasis industrial equivalente siempre que respete la cinemática omnidireccional, la carga útil moderada y la separación entre navegación, seguridad y proceso. Esta forma de especificar evita una debilidad habitual en ofertas académicas: confundir un robot disponible en simulador con el equipo que se compraría para una nave aeronáutica.
...
Control de navegación & Fusión LiDAR--IMU--encoders para pose; SLAM/mapa; ruta global A*/Dijkstra; evitación local DWA o campos potenciales. & Alinea la propuesta con localización, planificación y anticolisión del curso sin vender un algoritmo como garantía universal.\\
...
Interfaz e integración & HMI/tablet, WiFi industrial, base de datos de misiones y conectores progresivos hacia MES/ERP. & La solución debe dejar evidencia operativa y poder crecer sin exigir integración total desde el piloto.\\
\bottomrule
\caption{Especificación técnica de la plataforma AMR omnidireccional objetivo.}
\label{tab:especificacion-amr-objetivo}
\end{longtable}

La decisión clave es mantener tres niveles claros: \textit{YouBot/Omnirob} para simular cinemática, MiR250/LD-250 para acotar orden de magnitud comercial y AMR omnidireccional industrial como plataforma final. Con esa trazabilidad, el presupuesto no fuerza una compra incompatible con el criterio técnico: las referencias de 250 kg sirven para dimensionar coste y carga, mientras que la licitación exigiría base holonómica o mecanum equivalente.
