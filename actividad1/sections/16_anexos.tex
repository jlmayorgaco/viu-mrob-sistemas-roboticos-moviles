...
\begin{summarybox}
\textbf{Evidencia 3: implicaciones robóticas.} El experto descarta fabricar el HTP con un robot móvil y centra el alcance en AMR para kitting, retorno de útiles, inspección preventiva FOD, registro RFID/QR, navegación segura con operarios y despliegue piloto medido con KPIs.
\end{summarybox}
...
Propuesta de solución con robot móvil disponible en CoppeliaSim. & AMR omnidireccional tipo KUKA YouBot/Omnirob en simulación y clase RB-KAIROS/AGILOX para implantación. & Cumplido\\
...
\midrule
\endhead
Entrevista 20\% & Ficha, acta técnica, conversación simulada con Carlos Pérez, hallazgos e implicaciones directas para el diseño robótico. & Completa\\
