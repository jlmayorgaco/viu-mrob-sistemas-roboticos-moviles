...
Para simular la entrevista se utilizó ChatGPT con el prompt oficial de la guía para conversar con Carlos Pérez, trabajador con más de diez años de experiencia en Alestis Puerto Real. Esta entrevista está transcrita y adaptada de la conversación con ChatGPT; la evidencia visual disponible se incluye en el \hyperref[sec:anexo-capturas-entrevista]{Anexo A.2}. 
...
Objetivo & Las respuestas se usan para definir requisitos, selección de robot, sensores, arquitectura, presupuesto y KPIs.\\
\end{tabularx}
\end{interviewbrief}
...
\InterviewExchange
{¿El entorno de Cádiz influye en cómo se trabaja en planta?}
...
{No diría que el robot duplica producción. Eso es venderse mucho. Ayuda en cosas concretas: menos esperas, menos búsquedas, entregas más fiables y mejor registro. Para llegar a 80 hacen falta planificación, gente, calidad y capacidad de estación. El robot aporta una parte, no toda la solución.}
...
De la entrevista salen varias decisiones de diseño. El robot trabaja en logística auxiliar: carros, kits, útiles, herramientas y consumibles. El registro ocurre en origen y destino, porque saber que el material existe no alcanza para saber que está en la estación. El piloto se mide con datos de operación antes de pasar a flotas grandes.
