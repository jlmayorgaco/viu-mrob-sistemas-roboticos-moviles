...
El escenario de 1 robot es un piloto, no el despliegue definitivo. Debe medir rutas, aceptación de operarios, calidad de lecturas RFID/QR, tiempo de entrega y falsos positivos FOD en un entorno controlado. Con 7 robots ya se cubren varias estaciones y se prueba gestión de flota con prioridades, retornos de útiles y rondas preventivas. Los 17 robots solo tendrían sentido si los datos de las fases previas muestran que la planta necesita más cobertura para sostener el crecimiento hacia 80 HTP/mes o más.

El presupuesto reduce la especulación al separar equipo, sensores, software y servicios. La plataforma se apoya en modelos industriales identificables; los sensores, en componentes comerciales concretos; y el software/servicios, en rangos de integración publicados para AMR. Las partidas de ingeniería cubren levantamiento de planta, mapa, zonas seguras, reglas de tráfico, simulación, pruebas, aceptación y documentación de seguridad.
