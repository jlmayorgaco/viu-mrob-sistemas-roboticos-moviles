...
\end{subfigure}
\caption{Referencias visuales de Alestis Puerto Real incluidas en la guía de la actividad, procedentes de la página de montaje de Alestis \cite{alestisMontaje}.}
