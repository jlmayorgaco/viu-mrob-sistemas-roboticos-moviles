...
Cada problema operativo se traduce en un requisito, una función técnica y un indicador de verificación. La tabla siguiente evita una lista de componentes desconectada del caso de planta.
...
La evidencia mínima para cerrar el piloto debe incluir mapa de rutas, listado de misiones, histórico de alarmas, registro de entregas RFID/QR, capturas FOD, encuesta de usuarios y comparativa de tiempos antes y después. Esa evidencia no certifica procesos aeronáuticos; sirve para decidir con datos si el sistema reduce esperas, recorridos e incidencias.
